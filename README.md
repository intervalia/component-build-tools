...
| --- | --- | --- |
| 07/24/2018 | 2.1.1 | &#x25cf; Fixed tests to run on Windows as well as other OSs.<br/>&#x25cf; Handle windows `path.join()` with inclusion of drive letter: `C:\`<br/>&#x25cf; Revert to simple minification if `html-minify` fails.<br/>&#x25cf; Updated version and docs |
